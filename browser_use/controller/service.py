...
class Controller:
	...
	def _register_default_actions(self):
		...
		@self.registry.action('Click element.  NOTE: Use download file URL element instead to download.  Ctrl+S does not function for download.', param_model=ClickElementAction)
